...
var fs = require('fs');
var folderToStart = "src/";
var folderToOutput = "build";
...
function build() {
    return __awaiter(this, void 0, void 0, function () {
        var files, _loop_1, _i, files_1, file, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, fs.promises.readdir(folderToStart)];
                case 1:
                    files = _a.sent();
                    _loop_1 = function (file) {
                        ...
                        output.children.forEach(function (child) {
                            if (child.type === 'code') {
